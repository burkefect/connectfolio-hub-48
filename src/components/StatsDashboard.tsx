...
import { FileText, Globe, Link, Image, PenTool, Briefcase } from 'lucide-react';

const FeaturesDashboard: React.FC = () => {
  return (
    <section id="features" className="py-20 bg-secondary/30 dark:bg-gray-800">
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Free Resume Builder */}
          <Card className="overflow-hidden bg-white/80 dark:bg-gray-800 backdrop-blur-sm shadow-sm animate-slide-up">
            ...
            <CardHeader>
              ...
              <CardDescription className="dark:text-gray-300">Create professional resumes with our easy-to-use builder</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <div className="h-5 w-5 flex items-center justify-center rounded-full bg-primary/20 text-primary dark:bg-primary/30 dark:text-primary-foreground shrink-0 mt-0.5">✓</div>
          ...
          {/* Portfolio Website */}
          <Card className="overflow-hidden bg-white/80 dark:bg-gray-800 backdrop-blur-sm shadow-sm animate-slide-up animation-delay-200">
            <div className="bg-primary p-4 flex justify-center">
              <Globe className="h-12 w-12 text-primary-foreground" />
            </div>
            <CardHeader>
              <CardTitle>Portfolio Website + Hosting</CardTitle>
              <CardDescription className="dark:text-gray-300">Your professional online presence in minutes</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
          ...
          <Card className="overflow-hidden bg-white/80 dark:bg-gray-800 backdrop-blur-sm shadow-sm animate-slide-up animation-delay-400">
            <div className="bg-primary p-4 flex justify-center">
              <Briefcase className="h-12 w-12 text-primary-foreground" />
            </div>
            <CardHeader>
              <CardTitle>Digital Business Cards</CardTitle>
              <CardDescription className="dark:text-gray-300">Share your details with just a tap or scan</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
        ...
        <div className="mt-16 p-6 bg-white/80 dark:bg-gray-800 backdrop-blur-sm rounded-xl shadow-sm animate-fade-in animation-delay-600">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="inline-flex items-center justify-center p-4 bg-primary/10 dark:bg-primary/20 rounded-full mb-4">
                <PenTool className="h-8 w-8 text-primary dark:text-primary-foreground" />
              </div>
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center p-4 bg-primary/10 dark:bg-primary/20 rounded-full mb-4">
                <Link className="h-8 w-8 text-primary dark:text-primary-foreground" />
              </div>
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center p-4 bg-primary/10 dark:bg-primary/20 rounded-full mb-4">
                <Image className="h-8 w-8 text-primary dark:text-primary-foreground" />
              </div>
